...
APP_VERSION_VAR="SABNZBD_VERSION"
APP_VERSION="${SABNZBD_VERSION:-latest}"
APP_DEPS=(curl tar jq)
APP_FPK_PREFIX="sabnzbd"
APP_HELP_VERSION_EXAMPLE="4.4.1"
...
app_get_latest_version() {
    ...
    [ -z "$APP_VERSION" ] && error "无法获取版本信息，请手动指定: $0 4.4.1"
...
app_build_app_tgz() {
    ...
    bash "$REPO_ROOT/scripts/apps/sabnzbd/build.sh"
