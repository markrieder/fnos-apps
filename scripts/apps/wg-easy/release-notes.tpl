...
- 基于 [WG-Easy ${VERSION}](https://github.com/wg-easy/wg-easy/releases/tag/v${VERSION})
- 平台: fnOS
- 默认端口: ${DEFAULT_PORT} (Web UI), 51820/udp (WireGuard)${REVISION_NOTE}
- 主页: ${HOMEPAGE_URL}

> **注意**: WG-Easy 需要 NET_ADMIN 和 SYS_MODULE 权限
